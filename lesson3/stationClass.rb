class Station
  attr_accesso :trains, :station_name #trains and station names are only available for reading

  def initialization (station_name, trains)
 ...
 class Route
  ...
  def initialization (first_station, last_station)
